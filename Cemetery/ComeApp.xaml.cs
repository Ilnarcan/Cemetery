...
{
    /// <summary>
    /// Логика взаимодействия для ComeApp.xaml
    /// </summary>
    public partial class ComeApp
    {
        ...
        public ComeApp(string y, string m, string d, int md, string per)
        {
            _year = y;
            _month = m;
            _day = d;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Label4.Content = "Приход материальных средств " + _period;
            if (!String.IsNullOrEmpty(_year) && !String.IsNullOrEmpty(_month) && !String.IsNullOrEmpty(_day))
            {
                ...
                string sqlquer = "SELECT ID,date,supplier,name,unit,number,sum,total FROM CA WHERE ";
                ...
                foreach (DataRow record in dtmem.Rows)
                {
                    _myTable.Rows.Add(new object[]
                    {
                       ...
                       CryptDec.NewForm(record["supplier"].ToString()), 
        ...
        private void button1_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                if (rowItem != null)
                {
                    ...
                    var supplierD = CryptDec.BackToForm(TextBox2.Text);
                ...
                _myTable.Columns[2].ColumnName = "Поставщик";
        ...
        private void button2_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                if (rowItem != null)
                {
                    ...
                    connection.Open();
                    var command = new SQLiteCommand("DELETE FROM CA WHERE ID = '" + strNum + "'", connection);
        ...
        private void button3_Click(object sender, RoutedEventArgs e)
        {
            ...
            string headerName = "Приход материальных средств " + _period;
            ...
            currentRow.Cells.Add(new TableCell(new Paragraph(new Run("Поставщик"))));
        ...
        private void TextBox7_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key == Key.Tab || e.Key == Key.NumPad0 || e.Key == Key.NumPad1 || e.Key == Key.NumPad2 || e.Key == Key.NumPad3 ||
                e.Key == Key.NumPad4 || e.Key == Key.NumPad5 || e.Key == Key.NumPad6 || e.Key == Key.NumPad7 ||
                e.Key == Key.NumPad8 || e.Key == Key.NumPad9 || e.Key == Key.D0 || e.Key == Key.D1 ||
                e.Key == Key.D2 || e.Key == Key.D3 || e.Key == Key.D4 || e.Key == Key.D5 || e.Key == Key.D6 ||
        ...
        private void button4_Click(object sender, RoutedEventArgs e)
        {
            ...
            var command2 = new SQLiteCommand("SELECT Count(*) FROM CA", connection);
            ...
            {
                numberdead++;
                var command3 = new SQLiteCommand("SELECT Count(*) FROM CA WHERE ID = '" + numberdead + "'", connection);
            ...
            string sqlquery = "INSERT INTO CA(ID,year,month,day,date,supplier,name,unit,number,sum,total) VALUES ('" +
