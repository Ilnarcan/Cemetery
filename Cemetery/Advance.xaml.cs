...
{
    /// <summary>
    /// Логика взаимодействия для Advance.xaml
    /// </summary>
    public partial class Advance
    {
        ...
        public Advance(string y, string m, string d, int md, string per)
        {
            _year = y;
            _month = m;
            _day = d;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Label4.Content = "Платежная ведомость на аванс " + _period;
            if (!String.IsNullOrEmpty(_year) && !String.IsNullOrEmpty(_month) && !String.IsNullOrEmpty(_day))
            {
                ...
                string sqlquer = "SELECT ID,tabel,master,sum FROM Ad WHERE ";
        ...
        private void button2_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                if (rowItem != null)
                {
                    ...
                    connection.Open();
                    var command = new SQLiteCommand("DELETE FROM Ad WHERE ID = '" + strNum + "'", connection);
        ...
        private void button3_Click(object sender, RoutedEventArgs e)
        {
            ...
            string headerName = "Платежная ведомость на аванс " + _period;
        ...
        private void Button4_Click(object sender, RoutedEventArgs e)
        {
            if (TextBox1.Text != "" && TextBox2.Text != "" && TextBox3.Text != "")
            {
                ...
                var command2 = new SQLiteCommand("SELECT Count(*) FROM Ad", connection);
                ...
                {
                    numberdead++;
                    var command3 = new SQLiteCommand("SELECT Count(*) FROM Ad WHERE ID = '" + numberdead + "'", connection);
                ...
                string sqlquery = "INSERT INTO Ad(ID,year,month,day,tabel,master,sum) VALUES ('" +
